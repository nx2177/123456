...
class ExperienceRelevanceScorer:
    """
    Agent C: Score the relevance of candidate's work experience
    """
    ...
    def process(self, job_experience, job_description):
        """
        Evaluate how relevant the candidate's work experience is to the job description
        ...
        system_prompt = """
        You are an experienced recruiter evaluating job candidates.
        Your task is to assess how well a candidate's work experience matches a specific job description.
        Provide a relevance score between 0.0 (not relevant at all) and 1.0 (perfectly relevant).
        Also provide a brief justification for your score in 2-3 sentences.
        Your analysis should consider:
        1. Relevant industry experience
        2. Similar roles and responsibilities
        3. Experience with required technologies or methodologies
        4. Career progression and leadership experience if applicable
        """
        
        prompt = f"""
        Please evaluate how relevant the candidate's work experience is to the job description.
        ...
        2. "justification": 2-3 sentences explaining your reasoning
        """
        ...
        try:
            ...
            try:
                ...
                if not result:
                    stronger_prompt = f"""
                    Evaluate the candidate's work experience against the job description.
            ...
            print(f"Error in experience scoring: {str(e)}")
